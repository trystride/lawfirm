...
const teamMembers = [
  ...
  {
    name: "محمد مساعد الصيخان",
    role: "محامي",
    qualifications: [
      "باحث ماجستير في تخصص القانون الخاص بجامعة الملك سعود حاصل على درجة البكالوريوس في القانون",
      "خبرة في الترافع بالقضايا التجارية، الصحية، والإدارية مهارة في إعداد وصياغة عقود تأسيس الشركات المساهمة خبرة في تحويل الكيانات القانونية للشركات"
    ],
