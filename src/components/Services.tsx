...
import { Scale, Building2, FileText, GraduationCap, Briefcase, LayoutGrid, X } from 'lucide-react'
...
const services = [
  ...
  {
    icon: LayoutGrid,
    title: "المساندة القانونية وتطوير الإدارات",
    description: [
      "تصميم وتطوير الهياكل التنظيمية للإدارات القانونية في المؤسسات والشركات",
      "إعداد ومراجعة اللوائح والسياسات الداخلية بما يتوافق مع الأنظمة السعودية",
      "تعزيز مبادئ الحوكمة وضمان التزام المنشآت بالقوانين واللوائح ذات الصلة"
    ]
  }
]
